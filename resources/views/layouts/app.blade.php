        ...
        <div class="container d-flex">
            <ul class="navbar-nav d-flex flex-fill justify-content-between align-items-center">
                <li class="nav-item d-flex align-items-center position-relative">
                    <a class="nav-link" href="#"><img src="https://inesan.eu/wp-content/uploads/2020/10/logo_Inesan-bile-260x65-1.png"></a>
                ...
                <div class="d-flex">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white logout" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Odhlásit
        ...
        <ul class="navbar-nav navigation">
            ...
            <li class="nav-item mx-4 dropdown">
                ...
                <ul class="dropdown-menu border-0 rounded-0 shadow-sm">
                    <li><a class="dropdown-item px-2" href="/user-create">Přidat uživatele<i class="fas fa-user-plus mx-2"></i></a></li>
                </ul>
            </li>
        </ul>
    </nav>
